  ...
  navigation: [
    {
      ...
      label: "News",
      description:
        "Read personalized headlines from enabled sources. Marking a story less like this removes it right away and refills its spot from stories already loaded. Today's list shows each publisher's icon beside its headlines, on a small light tile so it reads in both the light and dark theme, with the name on hover.",
      path: "/news",
      icon: "newspaper",
      order: 34,
