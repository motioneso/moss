# Build Handoff — 1702-appmap-lane-c
...
**Worktree:** ~/Jarv1s/.claude/worktrees/1702-appmap-lane-c **Branch:** 1702-appmap-lane-c (off origin/main)
...
`notifications`, `people`, `proactive-monitoring`, `settings`, `sports`
...
None — the other three lanes (`1702-appmap-lane-a/b/d`) touch a disjoint set of modules. No shared
files.
