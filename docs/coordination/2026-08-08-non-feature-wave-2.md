...
| --- | --- | --- | --- | --- | --- | --- |
| `docs/superpowers/specs/2026-08-08-non-feature-wave-2.md` | #1155 | routine | PR open (mergeable), gate green on 3rd isolated-DB run (186/186 files, 1872 passed/2 skipped; first two flaked on unrelated tuple-contention, not this diff), pre-push trio clean, live-path N/A (non-UI backend fix) per build agent — QA spawned to independently confirm the exemption and the regression test | `pr1155successor` (w1:p2G) | `fix-1155-schedule-key-slash` | #1480 |
