...
**Lane status:**
- **#1784** (routine, chip fix): still building in pane `w1:p2R`, agent `issue-1784-chip`. No PR yet. Not checked on recently — check it first on adoption.
...
2. Check #1784 (`w1:p2R`) — has not been checked recently, confirm it is still alive.
