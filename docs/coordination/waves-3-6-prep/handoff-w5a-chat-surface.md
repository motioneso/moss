...
**Worktree:** ~/Jarv1s/.claude/worktrees/w5a-chat-surface **Branch:** w5a-chat-surface (off origin/main)
...
- Wave 5 lanes A-D are disjoint by file ownership inside `apps/web` per the collision map — read
  the spec's per-lane file split before starting so you stay inside your own files. Lanes B
  (#1259/#1260), C (#1254), D (#1255/#1451) are building concurrently with you against the same
  spec.
