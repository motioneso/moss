...
**Worktree:** ~/Jarv1s/.claude/worktrees/w3a-audit-truth **Branch:** w3a-audit-truth (off origin/main)
...
- This spec has 3 lanes (A/B/C) all landing in Wave 3 — read the spec's lane/file-split section
  before touching any file another lane might also own. Lanes B (#1055) and C (#1136) are building
  concurrently with you against the same spec.
