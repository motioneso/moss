...
**Worktree:** ~/Jarv1s/.claude/worktrees/w3b-audit-truth **Branch:** w3b-audit-truth (off origin/main)
...
- This spec has 3 lanes (A/B/C) all landing in Wave 3 — read the spec's lane/file-split section
  before touching any file another lane might also own. Lanes A (#1256/#1252/#1251) and C (#1136)
