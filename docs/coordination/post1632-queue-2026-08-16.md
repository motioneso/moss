...
| docs/superpowers/specs/2026-08-09-wave-4-external-module-supply-chain.md (last item, lane C) | #1279 | security | **QA GREEN, awaiting Ben's merge sign-off** — [PR #1645](https://github.com/motioneso/moss/pull/1645), [Opus QA verdict](https://github.com/motioneso/moss/pull/1645#issuecomment-5309770289): merge-ready, 0 blocking, confirmed the change is message-formatting-only (validation logic untouched). 6 non-blocking follow-up candidates (mainly: only 1 of 3 call sites has a test proving the tool-name prefix reaches the error) | pr1279-relay3 | w1:pCV | 1279-external-module-gateway-validator | **awaiting Ben** |
...
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1038 | security | **doc fix pushed, re-QA in progress** — [PR #1643](https://github.com/motioneso/moss/pull/1643) at `553400272`, wording corrected in PR body + handoff doc (no code/test change), pre-push trio rc=0, rebased clean on `3151e437b`. Scoped re-QA spawned (agent `requa-1643-1038`) to confirm only the wording fix, not re-review test code | PR1038 chat privacy relay | w1:pCT | 1038-chat-privacy-leak-test | re-QA running |
