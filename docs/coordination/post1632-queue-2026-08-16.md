...
| docs/superpowers/specs/2026-08-15-1589-job-failure-incident-closure.md (Phase 1 only — Phase 2 split to #1634) | #1589 | sensitive | PR #1636 open, **QA RED**, resolving both blockers (CI rerun-confirm + live-path evidence/correction); relay2→relay3 at 70% ckpt, relay2 also fixed a NUL-byte corruption in its own handoff doc pre-relay (`7b89e0278`) | PR1589 Phase1b relay3 | w1:pBX | build-1589-phase1b | #1636 |
