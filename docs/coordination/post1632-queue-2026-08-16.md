...
**Next:** await the two new QA verdicts (notes-mutex routine, weather-SSRF security-Opus); await
#1416/#1516 proof re-posts then spawn confirm-QA; await #1688's real CI diagnosis.
