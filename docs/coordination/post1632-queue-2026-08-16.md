...
| docs/superpowers/specs/2026-08-15-1589-job-failure-incident-closure.md (Phase 1 only — Phase 2 split to #1634) | #1589 | sensitive | fix+tests green (70/70), file-size gate fix landed, full verify:foundation + live-path + wrap-up pending | PR1589 Phase1b relay2 | w1:pBW | build-1589-phase1b | — |
