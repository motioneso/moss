...
ruling was ready; sent to the same pane, to be read on resume since no new pane had spawned yet.
Lane status: relaying, not blocked — resume with the ruling in hand.
