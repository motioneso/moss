...
Next: once #1666/#1668 CI settles green, dispatch `coordinated-qa` (routine tier, per brief) on
each. Predecessor pane (`w1:pE4`, session `4ee1f279-6c18-411a-8da1-792ed151a5ef`) being closed now
that this entry is committed and the fleet is adopted.
