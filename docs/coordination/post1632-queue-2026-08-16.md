...
| docs/superpowers/specs/2026-08-15-1589-job-failure-incident-closure.md (Phase 1 only — Phase 2 split to #1634) | #1589 | sensitive | fix+tests green (70/70), gate running, no PR yet | PR1589 Phase1b memory data-loss fix | w1:pBR | build-1589-phase1b | — |
