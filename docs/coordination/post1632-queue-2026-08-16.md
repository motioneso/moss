...
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1468 | security | Task 1 (rewrap-secrets.ts) committed `858d694cb`, **building** (2 relays, successor `pr1468-target-guard-3` doing Task 3 then Task 2 w/ the 4 required changes) | pr1468-target-guard-3 | w1:pCW | 1468-target-identity-guard-extend | — |
