...
- [ ] **Ben: confirm readiness to resume #1013/PR #1624** given the real design collision with
      #1632 (not a mechanical rebase) — proceed with rebase+reconcile+P1′ re-run per the binding
      kill-gate, or want a fresh look first?
- [ ] **Ben: #1589 and #895 both lack approved specs.** Per process gate, Fable authors these
      before any build spawns. Confirm dispatching spec-writing to Fable for both, in that order.
