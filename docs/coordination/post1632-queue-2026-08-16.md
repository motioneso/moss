...
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1038 | security | tests committed `eeaaddbdc`, no RLS gap found (defense-in-depth confirmed), **relaying to successor** for gate+PR | PR1038 chat-privacy leak | w1:pCN | 1038-chat-privacy-leak-test | — |
