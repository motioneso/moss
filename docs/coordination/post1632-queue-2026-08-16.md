...
| docs/superpowers/specs/2026-08-17-1319-signed-module-catalog.md | #1319 | security | **queued — awaiting Ben's spawn sign-off** (main CI resolved 2026-08-17, waived; no other blocker). Plan: `git worktree add .claude/worktrees/build-1319-signed-module-catalog -b build-1319-signed-module-catalog origin/main`. Touches `module-registry/distribution/*` and `external/{validate,reconcile}.ts`; migration `packages/news/sql/0185_*.sql` reserved but #1319 itself doesn't need one per spec — confirm at build time. Parallel-safe against #1586 and Group A; 3 shared-file touch points vs #1586 to flag in handoff (`apps/api/src/server.ts` L459/L485, `packages/settings/src/routes.ts` ~994/1000, `platform-api.ts` barrel) | — | — | build-1319-signed-module-catalog (not created) | — |
