...
| docs/superpowers/specs/2026-08-09-wave-4-external-module-supply-chain.md (last item, lane C) | #1279 | security | **PR OPEN, ready for QA** — [PR #1645](https://github.com/motioneso/moss/pull/1645), full gate green (VF_EXIT=0, isolated gate DB), 29/29 tests pass, pre-push trio green, no user-facing surface | pr1279-relay3 | w1:pCV | 1279-external-module-gateway-validator | Opus QA spawning |
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1037 | security | **QA GREEN, awaiting Ben's merge sign-off** — [PR #1644](https://github.com/motioneso/moss/pull/1644), [Opus QA verdict](https://github.com/motioneso/moss/pull/1644#issuecomment-5309698207): merge-ready, 0 blocking, traced the real seam (no app-level ownership check, RLS is the sole guard, positive control closes the false-secure holes). 1 follow-up candidate filed as a suggestion, not a blocker (view-share-recipient-denied-resume test) | PR1037 chat-resume RLS relay2 | w1:pCZ | 1037-chat-resume-rls-test | **awaiting Ben** |
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1038 | security | **QA RED, doc-only fix in progress** — [PR #1643](https://github.com/motioneso/moss/pull/1643), [Opus QA verdict](https://github.com/motioneso/moss/pull/1643#issuecomment-5309696548): test code itself is fine, but the PR body/handoff doc wrongly claims the app-level ownership check in routes.ts is redundant to RLS — for share-grantee reads it's actually the sole guard (RLS there is owner-OR-share, the app check is owner-strict); not exploitable today (shares feature has no production callers) but wrong security documentation. No code/test change needed, just correct the wording. Relayed fix to build agent | PR1038 chat privacy relay | w1:pCT | 1038-chat-privacy-leak-test | fixing doc, then re-QA |
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1468 | security | **UNBLOCKED** — Ben answered via `needs-ben`: "Yes add as a part, a pr must never break prod." Relayed to build agent (self-relayed once more, relay6) — adding `JARVIS_RECONCILE_CONFIRM_OWNER_EMAIL` to prod deploy config as part of this PR, then wrap-up/open PR | pr1468-relay6 | w1:pD1 | 1468-target-identity-guard-extend | — |
