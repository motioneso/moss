...
| docs/superpowers/specs/2026-08-09-wave-4-external-module-supply-chain.md (last item, lane C) | #1279 | security | build DONE+GREEN (3 commits, verified locally: typecheck 0, 29/29 tests pass), **wrap-up running** (2 relays, successor `pr1279-relay3`) | pr1279-relay3 | w1:pCV | 1279-external-module-gateway-validator | — |
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1037 | security | **PR OPEN, ready for QA** — [PR #1644](https://github.com/motioneso/moss/pull/1644), full gate green (VF_EXIT=0, 1919/1921 pass), 2/2 new tests pass on first run, no RLS gap, tests-only (no app code touched) | PR1037 chat-resume RLS relay2 | w1:pCZ | 1037-chat-resume-rls-test | Opus QA spawning |
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1038 | security | **PR OPEN, ready for QA** — [PR #1643](https://github.com/motioneso/moss/pull/1643), full gate green (VF_EXIT=0, 1920/1922 pass), pre-push trio rc=0, tests-only (no app code change), no RLS gap found (defense-in-depth confirmed: app-level ownership check proven redundant to RLS) | PR1038 chat privacy relay | w1:pCT | 1038-chat-privacy-leak-test | Opus QA spawning |
| docs/superpowers/specs/2026-08-16-post1632-wave2-privacy-tests-and-target-guard.md | #1468 | security | **all 3 tasks committed** (`858d694cb`, `b303b2786`, `9a83990b6`), 6/6 new tests pass, **wrap-up running** (5 relays, successor `pr1468-target-guard-relay5` confirmed driving, old pane reaped). **MERGE-TIME FLAG FOR BEN**: `JARVIS_RECONCILE_CONFIRM_OWNER_EMAIL` isn't set in any deployment today — merging Task 2 alone breaks `module-install` on the next prod redeploy; logged to `AWAITING-BEN.md`, needs-ben ping deferred until PR opens | pr1468-target-guard-relay5 | w1:pCY | 1468-target-identity-guard-extend | — |
