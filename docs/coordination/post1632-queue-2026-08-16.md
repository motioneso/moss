...
**merges_since_relay:** 1 (PR #1635 / #895, routine, `e7ac4bef3`)
...
| docs/superpowers/specs/2026-08-15-1589-job-failure-incident-closure.md (Phase 1 only — Phase 2 split to #1634) | #1589 | sensitive | PR #1636 open, **QA RED** — CI rerun was pending + live-path claim wrong (upsertFileChunks is on the real notes.sync/memory-ingest path, not n/a per spec Exit Criterion 4); relayed back to build lane, re-report pending | PR1589 Phase1b relay2 | w1:pBW | build-1589-phase1b | #1636 |
