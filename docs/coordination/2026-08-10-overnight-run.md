...
| `docs/superpowers/specs/2026-08-10-1121-scriptable-uat-chat.md` | #1121 | sensitive | premises/seams + seed early-return gap documented; implementation plan pending Coordinator approval | `Issue #1121 scriptable UAT (relay3)`, session `5d633249-f321-45ea-a177-0afaea767cd1` | `build/1121-scriptable-chat` | #1565 merged |
