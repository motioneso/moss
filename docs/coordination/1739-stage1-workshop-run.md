...
| #1526 | [1140-D] propagate terminal socket backpressure to the PTY | routine per its own spec (handoff doc had said sensitive — spec wins) | QA in progress (PR #1803, agent a2246e0b65b658587) | pty-1526-relay3 | w1:pHP | 1526-pty-socket-backpressure | 1803 |
