# Build Handoff — 1702-appmap-lane-a
...
**Worktree:** ~/Jarv1s/.claude/worktrees/1702-appmap-lane-a **Branch:** 1702-appmap-lane-a (off origin/main)
...
`ai`, `briefings`, `calendar`, `chat`, `commitments`, `connectors`
...
None — the other three lanes (`1702-appmap-lane-b/c/d`) touch a disjoint set of modules. No shared
files.
