...
Code-grounded authoring guidance, originally audited 2026-09-04 against `~/Jarv1s` at
`bedfb0382`. Recovered on 2026-09-24; source code remains authoritative for current behavior.
...
This guide describes module contracts, not proof of a functioning Workshop build. The open
[Workshop redesign issue](https://github.com/motioneso/moss/issues/2023) tracks the missing
