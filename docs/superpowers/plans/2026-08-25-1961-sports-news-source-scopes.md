...
- Add migration `packages/sports/sql/0194_sports_news_source_scopes.sql`, register it in
...
- Integration coverage starts from migrations through `0193`, applies `0194`, and proves existing
...
- Migration `0194` preserves production assignments and RLS posture.
