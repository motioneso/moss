...
| Migration numbering        | Highest number across all `sql/` dirs is 0213                                                                                                                                                                                                                                                                                                                                           | New file `packages/sports/sql/0222_sports_source_photos.sql`. Re-check the highest number at build time; another in-flight PR may take 0214.                                                                                                                                                                                                                                            | None.                                                                                                                                                                                                 |
...
- `packages/sports/sql/0222_sports_source_photos.sql` — columns.
...
```sql
-- packages/sports/sql/0222_sports_source_photos.sql
